...
interface Phase4InteractiveConfirmationProps {
  recommendations: any[];
...
export default function Phase4InteractiveConfirmation({
  recommendations,
  onActionSelect,
  loading,
  className = ''
}: Phase4InteractiveConfirmationProps) {
  ...
  }, [selectedAction, displayStartTime]);
