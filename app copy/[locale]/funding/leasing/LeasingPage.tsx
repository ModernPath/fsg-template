...
export default function LeasingPage({ params }: Props) {
  const { locale } = params
  ...
  return (
    <main className="flex flex-col bg-background text-foreground">
      ...
      {/* Milloin leasing on järkevä valinta */}
        ...
        <div className="container mx-auto px-8 max-w-[1440px] relative z-10">
          <div className="max-w-4xl mx-auto mb-16">
            ...
            <div className="flex justify-center mb-8">
              <OptimizedImage
                src="/images/other/kerava.jpeg"
                alt="Kerava - leasingin helppo liukuminen eteenpäin"
                width={400}
                height={320}
      ...
      {/* Perinteiset pankit vs erikoistuneet */}
          ...
          <div className="max-w-4xl mx-auto mb-16">
            ...
            <div className="grid md:grid-cols-1 gap-8 mb-12">
              <div className="bg-gray-very-dark rounded-lg p-8">
                <h3 className="text-2xl font-semibold text-gold-primary mb-6">{t('comparison.bank.title')}</h3>
                <ul className="space-y-4 text-foreground/80">
                  {Array.isArray(t.raw('comparison.bank.points')) && Object.entries(t.raw('comparison.bank.points') as Record<string, string>).map(([key, point]) => (
              ...
              <div className="bg-gold-primary/10 rounded-lg p-8">
                <h3 className="text-2xl font-semibold text-gold-primary mb-6">{t('comparison.specialized.title')}</h3>
                <ul className="space-y-4 text-foreground/80">
                  {Array.isArray(t.raw('comparison.specialized.points')) && Object.entries(t.raw('comparison.specialized.points') as Record<string, string>).map(([key, point]) => (
                    <li key={key} className="flex items-start">
              ...
              <div className="bg-background/10 rounded-lg p-8">
                <h3 className="text-2xl font-semibold text-gold-primary mb-6">{t('comparison.digital.title')}</h3>
                <ul className="space-y-4 text-foreground/80">
                  {Array.isArray(t.raw('comparison.digital.points')) && Object.entries(t.raw('comparison.digital.points') as Record<string, string>).map(([key, point]) => (
                    <li key={key} className="flex items-start">
                      <ChartBarIcon className="w-5 h-5 text-blue-400 mr-3 mt-1 flex-shrink-0" />
                      {point}
                    </li>
                  ))}
                </ul>
      ...
      <section className="relative py-20 bg-gray-very-dark">
        <div className="container mx-auto px-8 max-w-[1440px] relative z-10">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold mb-8 text-gold-primary text-center">
              {t('whySpecialized.title')}
            </h2>

            <div className="text-xl leading-relaxed mb-8">
              <p className="mb-6">
                {t('whySpecialized.description')}
              </p>
            </div>
            ...
            <div className="bg-gold-primary/10 rounded-lg p-8 mb-8">
              <h3 className="text-2xl font-semibold text-gold-primary mb-4">
                ...
                {t('whySpecialized.example.title')}
              </h3>
              <div className="space-y-3 text-lg">
                {Array.isArray(t.raw('whySpecialized.example.points')) && Object.entries(t.raw('whySpecialized.example.points') as Record<string, string>).map(([key, point], index) => (
            ...
            <div className="grid md:grid-cols-1 gap-6">
              <div className="bg-background/10 rounded-lg p-6">
                <h3 className="text-xl font-semibold text-gold-primary mb-4">
                  {t('whySpecialized.betterChoice.title')}
                </h3>
                <ul className="space-y-3 text-foreground/80">
                  {Array.isArray(t.raw('whySpecialized.betterChoice.points')) && Object.entries(t.raw('whySpecialized.betterChoice.points') as Record<string, string>).map(([key, point]) => (
                    <li key={key} className="flex items-start">
                      <span className="text-gold-primary mr-2">•</span>
                      {point}
                    </li>
      ...
      <section className="relative py-20 bg-background">
        <div className="container mx-auto px-8 max-w-[1440px] relative z-10">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold mb-8 text-gold-primary text-center">
              {t('saleAndLeaseback.title')}
            </h2>

            <div className="text-xl leading-relaxed mb-8">
              <p className="mb-6">
                {t('saleAndLeaseback.description')}
              </p>
            </div>

            <div className="bg-gold-primary/10 rounded-lg p-8">
              <h3 className="text-2xl font-semibold text-gold-primary mb-4">
                {t('saleAndLeaseback.suitableWhen.title')}
              </h3>
              <ul className="space-y-3 text-foreground/80">
                {Array.isArray(t.raw('saleAndLeaseback.suitableWhen.points')) && Object.entries(t.raw('saleAndLeaseback.suitableWhen.points') as Record<string, string>).map(([key, point]) => (
                  <li key={key} className="flex items-start">
                    <CheckCircleIcon className="w-5 h-5 text-green-500 mr-3 mt-1 flex-shrink-0" />
                    {point}
                  </li>
            ...
            <div className="space-y-8">
              <div className="bg-red-500/10 border border-red-500/20 rounded-lg p-6">
                <h3 className="text-xl font-semibold text-red-400 mb-4">
                  ...
                  {t('mistakes.contractLength.title')}
                </h3>
                <p>
                  {t('mistakes.contractLength.description')}
                </p>
              </div>
              ...
              <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-lg p-6">
                <h3 className="text-xl font-semibold text-yellow-400 mb-4">
                  <ExclamationTriangleIcon className="w-6 h-6 inline mr-2" />
                  {t('mistakes.usageLimits.title')}
                </h3>
                <p className="mb-4">
                  {t('mistakes.usageLimits.description')}
                </p>
                <div className="bg-yellow-500/5 rounded p-4">
                  <p className="text-sm">
                    <strong>{locale === 'sv' ? 'Exempel' : locale === 'en' ? 'Example' : 'Esimerkki'}:</strong> {t('mistakes.usageLimits.example')}
                  </p>
                </div>
              </div>
        ...
        <div className="container mx-auto px-8 max-w-[1440px] relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-12">
              <div className="bg-gray-very-dark rounded-lg p-6 text-left">
                <h3 className="text-xl font-semibold text-gold-primary mb-4">
                  <ClockIcon className="w-6 h-6 inline mr-2" />
                  {t('bestTime.optimize.title')}
                </h3>
                <ul className="space-y-2 text-foreground/80">
                  {Array.isArray(t.raw('bestTime.optimize.points')) && Object.entries(t.raw('bestTime.optimize.points') as Record<string, string>).map(([key, point]) => (
                    <li key={key}>• {point}</li>
                  ))}
                </ul>
              </div>
              ...
              <div className="bg-gold-primary/10 rounded-lg p-6 text-left">
                <h3 className="text-xl font-semibold text-gold-primary mb-4">
                  ...
                  {t('bestTime.remember.title')}
                </h3>
                <p className="text-foreground/80">
                  {t('bestTime.remember.description')}
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-8 max-w-[1440px] relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              {Array.isArray(t.raw('faq.questions')) && Object.entries(t.raw('faq.questions') as Record<string, { question: string; answer: string }>).map(([key, qa]) => (
                <div key={key} className="bg-background/10 rounded-lg p-6">
