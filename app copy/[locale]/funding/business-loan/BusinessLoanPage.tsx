...
export default function BusinessLoanPage({ params }: Props) {
  const { locale } = params
  const t = useTranslations('BusinessLoan')
  ...
  return (
    <main className="flex flex-col bg-background text-foreground">
      ...
      {/* Milloin yrityslaina on järkevä valinta */}
        ...
        <div className="container mx-auto px-8 max-w-[1440px] relative z-10">
          <div className="max-w-4xl mx-auto mb-16">
            ...
            <div className="flex justify-center mb-8">
              <OptimizedImage
                src="/images/other/pallomeri.jpeg"
                alt="Pallomeri - yrityslainan monipuoliset käyttömahdollisuudet"
                width={400}
                height={320}
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              ...
              <div className="bg-card border border-border rounded-lg p-6">
                <div className="flex items-center mb-4">
                  <ExclamationTriangleIcon className="w-6 h-6 text-gold-primary mr-3" />
            ...
            <div className="space-y-8">
              <div className="bg-red-500/10 border border-red-500/20 rounded-lg p-6">
                <h3 className="text-xl font-semibold text-red-400 mb-4">
                  ...
                  {t('mistakes.tooShort.title')}
                </h3>
                <p>
                  {t('mistakes.tooShort.description')}
                </p>
              </div>
              ...
              <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-lg p-6">
                <h3 className="text-xl font-semibold text-yellow-400 mb-4">
                  <ExclamationTriangleIcon className="w-6 h-6 inline mr-2" />
                  {t('mistakes.seasonality.title')}
                </h3>
                <p>
                  {t('mistakes.seasonality.description')}
                </p>
              </div>
