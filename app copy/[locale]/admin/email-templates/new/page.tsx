...
import { EmailTemplateType, EmailTemplateFormData } from '@/types/email'
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.error || 'Mallin luominen epäonnistui')
      }
  ...
  return (
    <div className="container mx-auto py-6 space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold">Uusi sähköpostimalli</h1>
          <p className="text-muted-foreground">
            Luo uusi sähköpostimalli rahoittajille lähetettäville viesteille
          </p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <Select value={formData.type} onValueChange={(value: EmailTemplateType) => handleInputChange('type', value)}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="welcome">Yleinen tervetuloa</SelectItem>
                      <SelectItem value="customer_welcome">Asiakkaan tervetuloa</SelectItem>
                      <SelectItem value="partner_welcome">Kumppanin tervetuloa</SelectItem>
                      <SelectItem value="document_upload">Dokumentit</SelectItem>
                      <SelectItem value="funding_options">Rahoitusvaihtoehdot</SelectItem>
                      <SelectItem value="progress_update">Prosessin päivitys</SelectItem>
                      <SelectItem value="notification">Järjestelmäilmoitus</SelectItem>
                      <SelectItem value="booking">Tapaamisen vahvistus</SelectItem>
        ...
        <div className="flex justify-end gap-2">
          ...
          <Button type="submit" disabled={loading}>
            ...
            {loading ? 'Tallennetaan...' : 'Tallenna malli'}
          </Button>
        </div>
      </form>
    </div>
